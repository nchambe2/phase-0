...
def bingo?
  case
    when @column_b.count("x") == 5 then  p "BINGO!", return_bingo_board
    when @column_i.count("x") == 5 then  p "BINGO!", return_bingo_board
    when @column_n.count("x") == 5 then  p "BINGO!", return_bingo_board
    when @column_g.count("x") == 5 then  p "BINGO!", return_bingo_board
    when @column_o.count("x") == 5 then  p "BINGO!", return_bingo_board
