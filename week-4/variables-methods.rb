...
# In order to define a method you have to use the keyword def, then the method name, then any parameters you plan to pass to the method, and finally close the definition by placing the word end. In between the def and the end keyword is where you place specific actions you want the method to perform.
